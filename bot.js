// ============================================================
// LEGENDARY BOT v5.3 – FINAL, NO SYNTAX ERRORS
// ============================================================
...
// ---- Load analyzer with correct destructuring ----
let LegendaryAnalyzer;
try {
    const analyzerModule = require('./analyzer.js');
    LegendaryAnalyzer = analyzerModule.LegendaryAnalyzer;
} catch (e) {
...
async function handleCommand(text, chatId) {
    ...
    else if (text === '/ping') await sendMessage('🏓 Pong! Bot is alive (v5.3).');
    else if (text === '/scan') {
        await sendTyping();
...
function startHealthServer() {
    const server = http.createServer((req, res) => {
        ...
        res.end(JSON.stringify({ status: 'alive', uptime: process.uptime(), version: '5.3' }));
    });
...
logger.info('🏆 LEGENDARY BOT v5.3 STARTING – FULLY AUDITED & SELF‑LEARNING');
